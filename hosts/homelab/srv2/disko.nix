  ...
  assertions = [
    {
      ...
      message = "srv2 disko: expected at least one longhorn disk in resources/homelab/disks.nix.";
    }
    {
      assertion = lib.length longhornLuksKeyFiles == 1 && lib.head longhornLuksKeyFiles != null;
      message = "srv2 disko: longhorn disks must define exactly one shared luksKeyFile in resources/homelab/disks.nix.";
    }
    {
      assertion = lib.length longhornPasswordFiles == 1 && lib.head longhornPasswordFiles != null;
      message = "srv2 disko: longhorn disks must define exactly one shared luksPasswordFile in resources/homelab/disks.nix.";
    }
  ];
